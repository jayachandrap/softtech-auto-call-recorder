...
public class CustomListContactAdapter extends BaseAdapter {
	...
	public CustomListContactAdapter(Context context) {
		...
		// Get blackList here From database here, danh sach blacklist la thay doi
...
//		}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            viewHolder.contactName = (TextView) convertView.findViewById(R.id.tvContactName);
		...
		if(checkBlackList(blackList,a.get_phone_number())){
        ...
        viewHolder.btnOnOff.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if(isChecked == false && !checked){
					// Them vao Blacklist
					Contact aContact = new Contact(listContact.get(position).get_id(),listContact.get(position).get_name(), listContact.get(position).get_phone_number(),listContact.get(position).get_contact_id());
